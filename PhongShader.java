...
public class PhongShader extends Shader {
	...
	public PhongShader(){
		...
		addFragementShaderFromFile("phongFragment.fs");
		compileShader();
		...
		for(int i = 0; i< MAX_SPOT_LIGHTS; i++){
			...
			addUniform("spotLights[" + i + "].direction");			addUniform("spotLights[" + i + "].cutoff");
		}
	}
	...
	public static void setPointLight(PointLight[] pointLights){
		...
		if(pointLights.length > MAX_POINT_LIGHTS){
			System.err.print("Err: you passed in too many point lights");
	...
	public static void setSpotLight(SpotLight[] spotLights){
		...
		if(spotLights.length > MAX_SPOT_LIGHTS){
			System.err.print("Err: you passed in too many spot lights");
			new Exception().printStackTrace();
			System.exit(1);
		}
